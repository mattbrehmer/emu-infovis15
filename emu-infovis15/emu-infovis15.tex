...
\bstart{Coordinated matrix and boxplots} a variant of our design described in Section~\ref{design:workflows} has been incorporated into the redesigned Energy Manager; the matrix is labeled as a {\it Site Overview} to avoid the {\it heat map} misnomer, and corresponds well with our characterization of the Overview ({\bf T1}) task. 
...
Meanwhile, the boxplots, now referred to as {\it Value Range} visualizations, update when the energy worker brushes the matrix by hovering over a cell in the corresponding matrix row, similar to the behaviour of the prototype we described in Section~\ref{design:workflows}. 
...
Thanks to M. Borkin, A. Cri\c{s}an, J. Dawson, J. Fulda, E. Hoque, S.-H. Kim, N. Mahyar, and J. McGrenere for their feedback on the paper. 
